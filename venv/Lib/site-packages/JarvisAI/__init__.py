...
try:
    from JarvisAI.features.face_reco.dataset_create import DatasetCreate
    from JarvisAI.features.face_reco.train import Train
    from JarvisAI.features.face_reco.predict import Predict
    from JarvisAI.features.face_reco.open import Open
    from JarvisAI.features.send_mail import email_send
    from JarvisAI.features.setup import setup
